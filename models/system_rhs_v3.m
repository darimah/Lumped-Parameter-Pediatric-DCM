function dx = system_rhs_v3(t, x, clinical, params)
V_la = x(1); V_lv = x(2); V_ra = x(3); V_rv = x(4);
P_ao = x(5); Q_ao = x(6); P_as = x(7); Q_as = x(8); V_vs = x(9);
P_po = x(10); Q_po = x(11); P_ap = x(12); Q_ap = x(13); V_vp = x(14);
...
dx = [dV_la; dV_lv; dV_ra; dV_rv; dP_ao; dQ_ao; dP_as; dQ_as; dV_vs; dP_po; dQ_po; dP_ap; dQ_ap; dV_vp];
end
